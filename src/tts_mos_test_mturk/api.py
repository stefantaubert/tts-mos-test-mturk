...
def grant_bonuses_from_df(df: pd.DataFrame, mturk: MTurkClient):
...
def approve_from_df(df: pd.DataFrame, mturk: MTurkClient):
  dlogger = get_detail_logger()
  all_successful = True
...
def reject_from_df(df: pd.DataFrame, mturk: MTurkClient):
  dlogger = get_detail_logger()
  all_successful = True
